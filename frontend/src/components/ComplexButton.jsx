...
const ButtonRoot = React.forwardRef(function ButtonRoot(props, ref) {
  ...
  return (
    <svg width="120" height="40" {...other} ref={ref}>
      <polygon points="0,40 0,0 120,0 120,40" className="bg" />
      <polygon points="0,40 0,0 120,0 120,40" className="borderEffect" />
...
export default function UnstyledButtonCustom(props) {
    ...
    //   console.log(typeof(props.name))
       <Link to={'/' + props.name}><SvgButton>{props.name}</SvgButton></Link>
    )
}
